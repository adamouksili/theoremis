...
export function playgroundShell(): string {
  ...
  <nav class="landing-nav">
    ...
    <div class="landing-nav-links">
      ...
      <a href="https://playground.theoremis.com" class="landing-nav-link" style="color:var(--l-accent)">Playground</a>
      <a href="https://api.theoremis.com" class="landing-nav-link">API</a>
      <a href="https://classroom.theoremis.com" class="landing-nav-link">Classroom</a>
